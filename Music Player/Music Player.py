...
# bg_image = PhotoImage(file="2.jpg")
# bg_label = Label(root, image=bg_image)
# bg_label.place(x=0, y=0, relwidth=1, relheight=1)

# Create a frame for widgets
widget_frame = Frame(root, bg="black")
widget_frame.place(relx=0.1, rely=0.1, relwidth=0.8, relheight=0.8)

# Song Length Info (unchanged)

# Rest of your functions (unchanged)

# Playlist box
song_box = Listbox(widget_frame, bg="gray", fg="white", width=65, height=12,
                   selectbackground="black", selectforeground="white")
song_box.grid(row=0, column=0)

# Player Control Buttons Images (unchanged)

# Frame (unchanged)

# Player Control Buttons (unchanged)

# Rest of your widgets and buttons (unchanged)
...
# Rest of your sliders (unchanged)

# Volume Slider (unchanged)

# Volume Label (unchanged)
